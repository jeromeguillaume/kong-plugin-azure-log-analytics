...
This plugin sends Kong Gateway log data directly to Azure Log Analytics  with the [HTTP Data Collector REST API](https://learn.microsoft.com/en-us/rest/api/loganalytics/create-request).
